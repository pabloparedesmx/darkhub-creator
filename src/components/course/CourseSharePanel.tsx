...
const CourseSharePanel = ({ courseTitle }: CourseSharePanelProps) => {
  ...
  return (
    <div className="bg-card rounded-lg border dark:border-blue-500/20 p-6 shadow-sm dark:shadow-blue-500/5">
      ...
      <Button 
        variant="outline" 
        className="w-full mb-4 justify-center dark:border-blue-500/30 dark:hover:border-blue-500/50"
      ...
      <div className="flex justify-between">
        <Button 
          variant="outline" 
          size="icon" 
          className="rounded-md flex-1 mr-2 dark:border-blue-500/30 dark:hover:border-blue-500/50"
          onClick={() => {
        ...
        <Button 
          variant="outline" 
          size="icon" 
          className="rounded-md flex-1 mx-2 dark:border-blue-500/30 dark:hover:border-blue-500/50"
          onClick={() => {
        ...
        <Button 
          variant="outline" 
          size="icon" 
          className="rounded-md flex-1 ml-2 dark:border-blue-500/30 dark:hover:border-blue-500/50"
          onClick={() => {
