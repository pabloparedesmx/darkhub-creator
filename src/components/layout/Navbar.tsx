        ...
        <Link to="/" className="flex items-center gap-2">
          ...
          >
            <path 
              ...
              className={isHome ? "fill-white" : "fill-current"} 
              strokeWidth="2" 
              strokeLinecap="round"
            ...
            <path 
              d="M3 23L16 30L29 23" 
              className={isHome ? "stroke-white" : "stroke-current"} 
              strokeWidth="2" 
              strokeLinecap="round"
              strokeLinejoin="round"
            />
          ...
          <span className={cn("font-semibold", isHome && "text-white")}>
            Aprendiendo IA
          </span>
        </Link>
        ...
        <nav className="hidden md:flex items-center gap-6">
          <Link 
            ...
            className={cn(
              ...
              isHome && "text-white hover:text-white/80",
            ...
            {user ? (
              ...
              <>
                <Button 
                  ...
                  size="sm" 
                  asChild
                  className={isHome ? "text-white hover:text-white/80 hover:bg-white/10" : ""}
                >
                ...
                <Button 
                  ...
                  size="sm" 
                  asChild
                  className={isHome ? "text-white bg-white/10 hover:bg-white/20 border-white/10" : ""}
                >
